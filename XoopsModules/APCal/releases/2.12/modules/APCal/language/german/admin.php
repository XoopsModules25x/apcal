...
define('_AM_MODULEADMIN_CONFIG', 'Konfiguration');
...
define('_AM_MODULEADMIN_CONFIG_PHP', 'Erforderliche Php-Version %s (Ihre aktuelle Version ist %s)');
define('_AM_MODULEADMIN_CONFIG_XOOPS', 'Erforderliche Xoops-Version %s (Ihre aktuelle Version ist %s)');
define('_AM_PREFS', 'Einstellungen');
define('_AM_UPDATE', 'Update');
define('_AM_BLOCKS', 'Blöcke');
define('_AM_GOTOMODULE', 'Gehe zum Modul');
...
define("_AM_MYBLOCKSADMIN","APCal\'s Block&Gruppen-Admin");
...
// timezones
define("_AM_TZOPT_SERVER","Zeitzone des Servers");
define("_AM_TZOPT_GMT","Als GMT");
define("_AM_TZOPT_USER","Als Zeitzone des Users");
...
define( '_AM_FMT_SERVER_TZ_ALL' , "Server-Zeitzone (Winter): %+2.1f<br />Server-Zeitzone (Sommer): %+2.1f<br />Server-Zeitzonename: %s<br />Wert aus XOOPS config: %+2.1f<br />Wert, der von APCal verwednet wird: %+2.1f<br />" ) ;
...
define( '_AM_TH_SERVER_TZ_VALUE_TO' , "Änderung (-14.0??14.0)" ) ;
define( '_AM_JSALRT_SERVER_TZ' , "Vor dieser Aktion bitte zuerst ein Backup der Event-Tabellen anfertigen" ) ;
...
define('_AM_PI_TH_OPTIONS' , 'Optionen (normalerweise leer)' ) ;
...
define('_AM_ACTIVERIGHTS', 'Rechte Moduladministration');
define('_AM_ACCESSRIGHTS', 'Rechte Moduladministration');
