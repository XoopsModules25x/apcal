...
define("_MI_APCAL_BNAME_COMING_DESC","Mostrar os pr…Ùimos eventos");
...
define("_MI_APCAL_ADMENU_CAT2GROUP","Permiss‰Æs das Categorias");
define("_MI_APCAL_ADMENU2","Permiss‰Æs Globais");
define("_MI_APCAL_ADMENU_TM","Tabela de Manutenîåo");
define("_MI_APCAL_ADMENU_ICAL","Importar iCalendar");

// Text for notifications
define('_MI_APCAL_GLOBAL_NOTIFY', 'Global');
define('_MI_APCAL_GLOBAL_NOTIFYDSC', 'Opî÷es globais de notificaîåo de APCal.');
define('_MI_APCAL_CATEGORY_NOTIFY', 'Categoria');
define('_MI_APCAL_CATEGORY_NOTIFYDSC', 'Opî÷es de notificaîåo que såÐ aplicadas na categoria atual.');
define('_MI_APCAL_EVENT_NOTIFY', 'Evento');
define('_MI_APCAL_EVENT_NOTIFYDSC', 'Opî÷es de notificaîåo que såÐ aplicadas no atual evento.');
...
define('_MI_APCAL_GLOBAL_NEWEVENT_NOTIFYDSC', 'Receber notificaîåo quando um novo evento for criado.');
define('_MI_APCAL_GLOBAL_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notificaîåo : Novo evento');
...
define('_MI_APCAL_CATEGORY_NEWEVENT_NOTIFYDSC', 'Receber notificaîåo quando um novo evento for criado na Categoria.');
define('_MI_APCAL_CATEGORY_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notificaîåo : Novo evento em {CATEGORY_TITLE}');
