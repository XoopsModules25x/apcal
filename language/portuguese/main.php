...
// index.php
define('_MB_APCAL_ERR_NOPERMTOUPDATE',"Você nåÐ tem permissåÐ para mudar eventos");
...
define('_MB_APCAL_ERR_NOPERMTOINSERT',"Você nåÐ tem permissåÐ para criar eventos");
define('_MB_APCAL_ERR_NOPERMTODELETE',"Você nåÐ tem permissåÐ para excluir eventos");
define('_MB_APCAL_ALT_PRINTTHISEVENT',"Imprimir este evento");

// print.php
define('_MB_APCAL_COMESFROM',"Este evento vóÎ de %s");
