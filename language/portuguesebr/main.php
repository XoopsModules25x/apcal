...
// index.php
define('_MB_APCAL_ERR_NOPERMTOUPDATE',"Você nåÐ tem autorizaîåo para alterar eventos.");
...
define('_MB_APCAL_ERR_NOPERMTOINSERT',"Você nåÐ tem autorizaîåo para criar eventos.");
define('_MB_APCAL_ERR_NOPERMTODELETE',"Você nåÐ tem autorizaîåo para apagar eventos.");
