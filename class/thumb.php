...
class Thumb
{
    static function make($filename, $maxWidth, $maxHeight)
    {
    ...
    static function save($filename, $maxWidth, $maxHeight)
    {
        ...
        switch($fileType)
        {
            case IMAGETYPE_JPEG: default: $img = imagecreatefromjpeg($imgPath); break;
            case IMAGETYPE_GIF: $img = imagecreatefromgif($imgPath); break;
            case IMAGETYPE_PNG: $img = imagecreatefrompng($imgPath); break;
        }
        ...
        switch($fileType)
        {
            case IMAGETYPE_JPEG: default: imagejpeg($nImg, $thumbPath, 75); break;
            case IMAGETYPE_GIF: imagegif($nImg, $thumbPath); break;
            case IMAGETYPE_PNG: imagepng($nImg, $thumbPath); break;
        }
    }
