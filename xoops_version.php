...
$modversion['config'][] = [
    'name'        => 'apcal_enableprint',
    'title'       => '_MI_APCAL_ENABLE_PRINT',
    'description' => '',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => '1',
...
// online registration
$modversion['config'][] = [
    'name'        => 'break_regonline',
    'title'       => '_MI_APCAL_REGONLINE',
    'description' => '',
    'formtype'    => 'line_break',
    'valuetype'   => 'textbox',
    'default'     => 'even'
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_mail_sender',
    'title'       => '_MI_APCAL_RO_MAIL_SENDER',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => 'webmaster@mydomain.tld',
];
$modversion['config'][] = [
    'name'        => 'apcal_ro_mail_sendername',
    'title'       => '_MI_APCAL_RO_MAIL_SENDERNAME',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => 'Calendar of APCal',
];
$modversion['config'][] = [
    'name'        => 'apcal_ro_mail_signature',
    'title'       => '_MI_APCAL_RO_MAIL_SIGNATURE',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => 'Your Team of APCal',
];
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo1',
    'title'       => '_MI_APCAL_RO_EXTRA1',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => '',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo1_obl',
    'title'       => '_MI_APCAL_RO_EXTRA1_OBL',
    'description' => '',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => '0',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo2',
    'title'       => '_MI_APCAL_RO_EXTRA2',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => '',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo2_obl',
    'title'       => '_MI_APCAL_RO_EXTRA2_OBL',
    'description' => '',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => '0',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo3',
    'title'       => '_MI_APCAL_RO_EXTRA3',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => '',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo3_obl',
    'title'       => '_MI_APCAL_RO_EXTRA3_OBL',
    'description' => '',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => '0',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo4',
    'title'       => '_MI_APCAL_RO_EXTRA4',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => '',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo4_obl',
    'title'       => '_MI_APCAL_RO_EXTRA4_OBL',
    'description' => '',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => '0',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo5',
    'title'       => '_MI_APCAL_RO_EXTRA5',
    'description' => '',
    'formtype'    => 'textbox',
    'valuetype'   => 'text',
    'default'     => '',
...
$modversion['config'][] = [
    'name'        => 'apcal_ro_extrainfo5_obl',
    'title'       => '_MI_APCAL_RO_EXTRA5_OBL',
    'description' => '',
    'formtype'    => 'yesno',
    'valuetype'   => 'int',
    'default'     => '0',
